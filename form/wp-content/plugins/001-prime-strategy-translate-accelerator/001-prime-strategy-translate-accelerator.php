...
php version 7.0.4, 5.6.18, 5.3.6, 5.2.5, 5.1.6
WordPress Version 2.9.2 - 4.4.2
apc version 5.1.3,3.0.19, 3.1.6
...
?>
<div class="wrap">
	<h2>001 Prime Strategy Translate Accelerator</h2>
...
<?php wp_nonce_field( 'prime_strategy_translate_accelerator' ); ?>
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<ul>
						<li><label for="cache_type_file"><input type="radio" name="cache_type" id="cache_type_file" value="file"<?php echo $s['cache_type'] == 'file' || ( $s['cache_type'] == 'apc' && ! function_exists( 'apcu_store' ) ) ? ' checked="checked"' : ''; ?> /> <?php _e( 'Files', 'prime-strategy-transelate-accelerator' ); ?></label><br />
...
<?php if ( function_exists( 'apcu_store' ) ) : ?>						<li><label for="cache_type_apc"><input type="radio" name="cache_type" id="cache_type_apc" value="apc"<?php echo ( $s['cache_type'] == 'apc' ) && function_exists( 'apcu_store' ) ? ' checked="checked"' : ''; ?> /> <?php _e( 'APC', 'prime-strategy-transelate-accelerator' ); ?></label></li><?php endif; ?>
					</ul>
				</td>
			</tr>
			<tr>
	...
	<div id="developper_information">
		<div id="poweredby">
			<a href="https://www.prime-strategy.co.jp/" target="_blank"><img src="<?php echo preg_replace( '/^https?:/', '', plugin_dir_url( __FILE__ ) ) . 'images/ps_logo.png'; ?>" alt="Powered by Prime Strategy" /></a>
		</div>
	</div>
</div>
<?php
...
new Prime_Strategy_Translate_Accelerator;
