...
const a2020menuCreatorOptions = {
  ...
  methods: {
    ...
    getMenuItems() {
      ...
      self.master.menuItems = uipMasterMenu.OGmenu;
      self.master.availableTop = uipMasterMenu.availableTop;
      self.master.availableSub = uipMasterMenu.availableSub;
      return;
    ...
    saveSettings() {
      ...
      let menuitems = JSON.stringify(self.user.currentMenu);
      let tops = JSON.stringify(self.master.availableTop);
      let subs = JSON.stringify(self.master.availableSub);
