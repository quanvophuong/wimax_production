        ...
        'stdClass' => [
            ...
            'post_content' => [
                '[page_header height="0px" margin="23px" type="subnav" align="center" depth="2" bg_color="rgb(255,255,255)" bg_overlay="#4da4fd"]'."\n"
                    ...
                    .'[divider align="center" width="110px" margin="-1.6em"]'."\n"
                    ."\n"
                    ...
                    ."\n"
                    .'<p>下記URLよりご確認ください。<br /><a href="https://www.uqwimax.jp/wimax/area/map/default/" target="_blank" rel="noopener">https://www.uqwimax.jp/wimax/area/map/default/</a></p>'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
