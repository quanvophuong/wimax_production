        ...
        'stdClass' => [
            ...
            'post_content' => [
                '[page_header height="0px" margin="30px" type="subnav" align="center" depth="2" bg_color="rgb(255,255,255)" bg_overlay="#4da4fd"]'."\n"
                    ...
                    ."\n"
                    .'<p>商品到着後、ご利用するエリアでの電波が入りづらかった場合は「対応エリア外による解約」を適用させていただきますので当社までご連絡ください。<br />「対応エリア外による解約」の条件は下記項目となりますので、必ずご確認ください。<br />商品到着から<span style="color: #ff0000;">８日以内</span>に端末をご返却<br />・契約金額から初期費用を除いた金額をご返金<br />・端末返却時の郵送費はお客様のご負担<br />・ご返金時の振込手数料はお客様のご負担<br />・端末の故障・液晶割れ・水没、SIM カードの破損・紛失、専用 AC アダプターの破損・紛失などの場合は適用外<br />・通信量が <span style="color: #ff0000;">5GB 以上</span>利用されていた場合は適用外</p>'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
