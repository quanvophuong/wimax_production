        ...
        'stdClass' => [
            ...
            'post_content' => [
                '[page_header height="0px" margin="30px" type="subnav" align="center" depth="2" title="よくある質問（FAQ）" bg_color="rgb(255,255,255)" bg_overlay="#4da4fd"]'."\n"
                    ...
                    ."\n"
                    .'<p><strong>【モバイルルーター】</strong>こちらよりご確認下さいませ。<br />'."\n"
                    .'<strong>【ホームルーター】</strong>こちらよりご確認下さいませ。</p>'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
                    ...
                    .'<div style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333; background-color: #f0f8ff; display: inline-block;">・商品到着から<span style="color: #ff0000;">８日以内</span>に端末をご返却<br />'."\n"
