        ...
        'stdClass' => [
            ...
            'post_content' => [
                '[page_header height="0px" margin="23px" type="subnav" align="center" depth="2" bg_color="rgb(255,255,255)" bg_overlay="#4da4fd"]'."\n"
                    ...
                    .'[row]'."\n"
                    ."\n"
                    .'[col span__sm="11" force_first="small" divider="0" padding__sm="0px 0px 0px 0px" margin__sm="0px 0px 0px 23px" align="center"]'."\n"
                    ."\n"
                    .'[button text="契約・解約について" style="outline" icon="icon-angle-down" link="#keiyaku"]'."\n"
                    ."\n"
                    .'[button text="端末について" style="outline" icon="icon-angle-down" link="#wifi"]'."\n"
                    ."\n"
