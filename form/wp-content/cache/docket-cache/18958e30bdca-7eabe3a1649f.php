...
return \Nawawi\DocketCache\Exporter\Hydrator::hydrate(
    ...
    [
        'stdClass' => [
            ...
            'post_content' => [
                '[page_header height="0px" margin="30px" type="subnav" align="center" depth="2" title="よくある質問（FAQ）" bg_color="rgb(255,255,255)" bg_overlay="#4da4fd"]'."\n"
                    ."\n"
                    .'[row]'."\n"
                    ."\n"
                    ...
                    ."\n"
                    .'<p style="text-align: center;"><span style="font-size: 90%;"><strong>よくある質問の内容はこちら</strong></span></p>'."\n"
                    .'[/ux_text]'."\n"
                    ...
                    ."\n"
                    .'<p><strong>【モバイルルーター】</strong><a href="/Users/owner/Desktop/WiMAX%E9%96%A2%E9%80%A3/%E3%80%90WiMAX%E3%80%91SCR01SWU/%E3%80%90WiMAX%E3%80%91SCR01SWU.pdf" target="_blank" rel="noopener"><span style="color: #00aae7;">こちら</span></a>よりご確認下さいませ。<br /><strong>【ホームルーター】</strong><span style="color: #00aae7;"><a style="color: #00aae7;" href="/Users/owner/Desktop/WiMAX%E9%96%A2%E9%80%A3/%E3%80%90WiMAX%E3%80%91L11/%E3%80%90WiMAX%E3%80%91L11.pdf" target="_blank" rel="noopener">こちら</a></span>よりご確認下さいませ。</p>'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
                    ...
                    .'</tbody>'."\n"
                    .'</table>'."\n"
                    .'<p><span style="font-size: 85%;">※1　端末本体の損害金についてはSIMカードや付属品の有無を問わず同額となります。 </span><br />'."\n"
                    .'<span style="font-size: 85%;">※2　盗難・紛失時に警察への届出をいただけない場合や、故障・液晶割れ・水没時に端末の返却が確認できない場合、</span><br />'."\n"
                    .'<span style="font-size: 85%;">安心補償オプションの加入の有無にかかわらず損害金として22,000円（税込）をご負担いただきます。 </span><br />'."\n"
                    .'<span style="font-size: 85%;">※3　付属品とは、ホームルータープランに付属の専用ACアダプターの事を指します。</span></p>'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
                    .'[accordion-item title="<strong>申し込み後にエリア外で接続できなかった場合、キャンセルできますか？</strong>"]'."\n"
                    ."\n"
                    .'<p>商品到着後、ご利用するエリアでの電波が入りづらかった場合は「対応エリア外による解約」を適用させていただきますので当社までご連絡ください。</p>'."\n"
                    .'<p style="text-decoration: underline 4px; text-decoration-color: #FFCC00;"><strong>「対応エリア外による解約」の条件は下記項目となりますので、必ずご確認ください。</strong></p>'."\n"
                    .'<div style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333; background-color: #f0f8ff; display: inline-block;">'."\n"
                    .'<p>・商品到着から<span style="color: #ff0000;">８日以内</span>に端末をご返却<br />'."\n"
                    .'・契約金額から初期費用を除いた金額をご返金<br />'."\n"
                    .'・端末返却時の郵送費はお客様のご負担<br />'."\n"
                    .'・ご返金時の振込手数料はお客様のご負担<br />'."\n"
                    .'・端末の故障・液晶割れ・水没、SIM カードの破損・紛失、専用 AC アダプターの破損・紛失などの場合は適用外<br />'."\n"
                    .'・通信量が <span style="color: #ff0000;">5GB 以上</span>利用されていた場合は適用外</p>'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
