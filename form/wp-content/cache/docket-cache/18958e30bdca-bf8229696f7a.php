        ...
        'stdClass' => [
            ...
            'post_content' => [
                '[page_header height="0px" margin="30px" type="subnav" align="center" depth="2" bg_color="rgb(255,255,255)" bg_overlay="#4da4fd"]'."\n"
                    ...
                    .'<th style="width: 25%; border-color: #bababa; height: 21px; border-style: solid;">区分</th>'."\n"
                    .'<th style="width: 25%; border-color: #bababa; height: 21px; border-style: solid;">安心補償未加入時</th>'."\n"
                    .'<th style="width: 25%; border-color: #bababa; height: 21px; border-style: solid;">安心補償ライト加入時</th>'."\n"
                    .'<th style="width: 25%; border-color: #bababa; height: 21px; border-style: solid;">安心補償フリー加入時</th>'."\n"
                    .'</tr>'."\n"
                    .'<tr style="border-color: #bababa;">'."\n"
                    .'<td style="width: 25%; border-color: #bababa; height: 21px; border-style: solid;">端末本体（※1）</td>'."\n"
                    ...
                    .'</tr>'."\n"
                    .'<tr style="border-color: #bababa;">'."\n"
                    .'<td style="width: 25%; border-color: #bababa; height: 21px; border-style: solid;">SIMカードのみ</td>'."\n"
                    ...
                    .'<td style="width: 25%; border-color: #bababa; height: 21px; border-style: solid;">付属品のみ（※3）</td>'."\n"
                    .'<td style="width: 25%; border-color: #bababa; height: 21px; border-style: solid; text-align: center;">6,600円</td>'."\n"
                    .'<td style="width: 25%; border-color: #bababa; height: 21px; border-style: solid; text-align: center;">6,600円</td>'."\n"
                    .'<td style="width: 25%; border-color: #bababa; height: 21px; border-style: solid; text-align: center;">6,600円</td>'."\n"
                    .'</tr>'."\n"
