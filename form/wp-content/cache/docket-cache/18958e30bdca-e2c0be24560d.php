        ...
        'stdClass' => [
            ...
            'post_content' => [
                '[page_header height="0px" margin="30px" type="subnav" align="center" depth="2" title="よくある質問（FAQ）" bg_color="rgb(255,255,255)" bg_overlay="#4da4fd"]'."\n"
                    ...
                    ."\n"
                    .'<strong>【モバイルルーター】</strong><span style="color: #00aae7;"><span style="color: #c0c0c0;">こちら</span></span>よりご確認下さいませ。'."\n"
                    .'<strong>【ホームルーター】</strong><span style="color: #00aae7;">こちら</span>よりご確認下さいませ。'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
                    ...
                    .'<div style="padding: 10px; margin-bottom: 10px; border: 1px solid #333333; background-color: #f0f8ff; display: inline-block;">'."\n"
                    ."\n"
                    .'・商品到着から<span style="color: #ff0000;">８日以内</span>に端末をご返却'."\n"
                    .'・契約金額から初期費用を除いた金額をご返金'."\n"
                    .'・端末返却時の郵送費はお客様のご負担'."\n"
                    .'・ご返金時の振込手数料はお客様のご負担'."\n"
                    .'・端末の故障・液晶割れ・水没、SIM カードの破損・紛失、専用 AC アダプターの破損・紛失などの場合は適用外'."\n"
                    .'・通信量が <span style="color: #ff0000;">5GB 以上</span>利用されていた場合は適用外'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
                    .'[accordion-item title="<strong>マイページにログインできません</strong>"]'."\n"
                    ."\n"
                    .'仮パスワードをご登録いただいておりますメールアドレス宛にお送りいたしますので、'."\n"
                    .'当社までご連絡ください。'."\n"
                    ."\n"
                    .'[/accordion-item]'."\n"
                    ."\n"
