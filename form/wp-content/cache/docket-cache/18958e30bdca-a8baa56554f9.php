        ...
        'stdClass' => [
            ...
            'post_content' => [
                '[page_header height="0px" margin="23px" type="subnav" align="center" depth="2" bg_color="rgb(255,255,255)" bg_overlay="#4da4fd"]'."\n"
                    ...
                    ."\n"
                    .'[ux_menu_link text="ホームへ戻る" icon="icon-angle-right" link="https://free-max.com/"]'."\n"
                    ."\n"
                    .'[ux_menu_link text="お問い合わせフォームへ" icon="icon-angle-right" post="38"]'."\n"
                    ."\n\n"
                    .'[/ux_menu]',
            ],
            'post_title' => [
